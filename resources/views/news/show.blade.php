        ...
        <div class="block">
                <div class="flex mb-4">
                    <div class="block px-4">
                        ...
                        <h1 class=" px-4 text-6xl font-bold text-blue-800">{{$news->title}}</h1>
                        </div>
                        <p class="roboto text-xl text-justify px-4 py-1">
                            {{$news->description}}
                        </p>
                        <br>
                        <div class="roboto text-xl px-4 py-1">
                            {!! $news->article !!}
                        </div>
                        <br>
                        <div class="flex px-4">
                            <div class="flex  px-4 py-1 mr-4">
                            {{-- Cantidad de Likes --}}
                            @if (!Auth::guest())
                            ...
                            @endif
                                <div class="roboto text-xl flex items-center">
                            ...
                            <div class="flex  px-4 py-1">
                                <div class="p-1 rounded-full mr-2">
                                    <img src="{{ asset('img/icons/commentBlack.svg') }}" alt="Comments-Icon" class="w-6 h-6">
                                </div>
                                <div class="roboto text-xl flex items-center">
                                    {{ $news->comments_count }} 
                                </div>
                            ...
                            <div class="flex  px-4 py-1">
                                ...
                                <a href="{{ route('categories.show', $news->category->slug) }}" class="flex  mx-2 py-1 hover:text-red-800 underline">
                        ...
                        <div class="flex justify-end px-4 mt-2">
                            ...
                            <div class="flex justify-center">
                                <div class="font-bold px-2 py-1 text-xl">
                        ...
                        <div class="flex justify-end px-4 mt-2">
                            ...
                            @if (!Auth::guest() && auth()->user()->role_id == 3)
                                <a href="{{ route('admin.users.edit', $news->writer) }}" class="flex  px-2 py-1 hover:text-red-800 underline">
                            @else
                                <a class="flex  px-2 py-1">
                            @endif
                        ...
                        <div class="flex justify-center">
                            <div class="block w-10/12">
                                @foreach ($news->comments as $comment)
                                    <div class=" text-center p-4 mb-8 border-2 border-solid border-gray-600 rounded">
                        ...
                        @if (!Auth::guest())
                            ...
                            <form action="{{ route('news.addComent') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="flex justify-center mb-4">
                                    <div class="block">
                                        <div class="flex justify-center">
                                            <label for="content" class="font-bold  mb-2">Agrega un comentario:</label><br>
                                        </div>
                        ...
                        @else
                            <div class="flex justify-center">
                                <div class="block p-4 rounded border border-yellow-600 border-2">
                                    <div class="flex justify-center">
                                        <img class="block w-8 text-center" src="{{ asset('img/icons/alert.svg')}}" alt="Alert!">
                                    </div>
                                    <p class="block text-xl font-bold">¡Inicia Sesión para poder comentar!</p>
                                    <div class="flex justify-center mt-4">
                                        <a href='{{ route('login') }}' class='block mt-1 px-2 rounded 
                                            {{-- text-black bg-gray-400 rounded hover:bg-red-800 hover:text-white hover:font-normal md:mt-0 md:ml-2 --}}
                                            bg-blue-800 text-white p-1 rounded hover:bg-white hover:text-black hover:font-bold border-blue-800 border-2'>
