        ...
        <div class="block">
                <div class="flex justify-center mb-4">
                    <div class="block">
                        ...
                        <p class="text-lg text-center px-4 py-1 border-2 border-solid rounded">
                            {{$news->description}}
                        </p>
                        <br>
                        ...
                        <div class="flex justify-center">
                            ...
                            {{-- Cantidad de Likes --}}
                            <div class="flex text-lg px-4 py-1 border-2 border-solid rounded mr-4">
                                <div class="p-1 mr-2">
                        ...
                        <div class="flex justify-center">
                            <a href="{{ route('admin.categories.show', $news->category_id) }}" class="flex text-lg px-4 py-1 border-2 border-solid rounded hover:text-red-800 underline">
                        ...
                        <div class="flex justify-center">
                            <span class="flex text-lg px-4 py-1 border-2 border-solid rounded ">
                        ...
                        <div class="flex justify-center mt-8">
                            @include('partials.ui.blueLinkButton', ['label' => 'Editar Noticia', 'url' => route('writer.news.edit', $news->id)])
                        </div>
                        <div class="flex justify-center mt-4">
                            <form action="{{ route('writer.news.destroy', $news->id) }}" 
                        ...
                        <div class="flex justify-center mt-4">
                            <a href="{{ url()->previous() == route('writer.news.edit', $news->id) || url()->previous() == route('writer.news.create')   ? route('writer.news.index') : url()->previous() }}" 
                        ...
                        {{-- ADD COMMENTS --}}
                        <form action="{{ route('writer.news.addComent') }}" method="POST" enctype="multipart/form-data">
                            @csrf
