        ...
        <div class="block">
            ...
            <div class="flex justify-center mb-4">
                <div class="block">
                    ...
                    class="roboto text-lg bg-white px-4 py-1 border-2 border-black border-solid rounded" required>{{ old('description',$news->description)}}</textarea>
                    @error('description')
                        <div class="text-red-800 text-center">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="flex justify-center mt-4">
                <a href="{{ route('writer.news.show', $news->id) }}" class="font-bold text-blue-800 hover:text-red-800 underline">← Regresar</a>
            </div>
        </div>
    </div>
