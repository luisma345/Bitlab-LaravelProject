        ...
        <div class="flex items-center justify-between px-2 py-1 md:px-0 md:py-0 md:w-full">
            ...
            <div id="opciones" class="hidden px-1 pb-1 md:flex md:p-0">
                ...
                <a href='/' class='block px-2 rounded 
                    rounded bg-red-800 text-white md:mt-0 md:ml-2'>
                @else
                    <a href='/' class='block px-2 font-semibold rounded text-black bg-gray-200 
                    rounded hover:bg-red-800 hover:text-white hover:font-normal md:mt-0 md:ml-2'>
                @endif
                    Inicio
                </a>
                ...
                @if ($menu=='categories')
                    <a href="{{ route('admin.categories.index') }}" class='block mt-1 px-2 rounded 
                    rounded bg-red-800 text-white md:mt-0 md:ml-2'>
                @else
                    <a href="{{ route('admin.categories.index') }}" class='block mt-1 px-2 font-semibold rounded text-black bg-gray-200 
                    rounded hover:bg-red-800 hover:text-white hover:font-normal md:mt-0 md:ml-2'>
                @endif
                    Categorías
                </a>
                ...
                @if ($menu=='about')
                    <a href='/' class='block mt-1 px-2 rounded 
                    rounded bg-red-800 text-white md:mt-0 md:ml-2'>
                @else
                    <a href='/' class='block mt-1 px-2 font-semibold rounded text-black bg-gray-200 
                    rounded hover:bg-red-800 hover:text-white hover:font-normal md:mt-0 md:ml-2'>
                @endif
                    Acerca
                </a>
